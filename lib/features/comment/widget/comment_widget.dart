...
class CommentForm extends StatefulWidget {
  ...
  const CommentForm({super.key, required this.user, required this.post});
...
class _CommentFormState extends State<CommentForm> {
  ...
  Future<void> _saveData() async {
    _showLoadingDialog(context, 'Đang trả lời...');
    ...
    var result = await PostDataSource().createComment(
      FullPostModel(
        postId: "",
        postContent: postContent,
        postImageUrl: postImage,
        postVideoUrl: _videoFile,
        postFileUrl: "",
        postTotalLikes: "0",
        postTotalComments: "0",
        postTotalShares: "0",
        ...
        actions: [
          Padding(
            ...
            child: ElevatedButton(
              onPressed: _saveData, 
              child: Text('Trả lời', style: TextStyle(color: Colors.white, fontSize: 16, fontWeight: FontWeight.w600)),
